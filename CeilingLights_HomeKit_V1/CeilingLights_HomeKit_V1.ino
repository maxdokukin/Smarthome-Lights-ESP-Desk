...
void setup() {
  ...
  rgb_colors[2] = 255;
	my_homekit_setup();
  //add reading hue from eeprom
  pf = new PerlinFade(0, 10000, 30, 10, 255, 240, 255);
...
void updateColor()
{
  if(is_on)
  {
      ...
      {
        //HSV2RGB(current_hue, current_sat, current_brightness);  -hueGap/2
        pf = new PerlinFade(map(current_hue, 0, 360, 0, 65535), 10000, 30, 10, 255, 240, 255);
